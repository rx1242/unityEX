...
/// /// </summary>
class SelectionVoiceAttribute : PropertyAttribute { }
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(SelectionVoiceAttribute))]

public class SelectionVoice : PropertyDrawer
{
    List<string> list;
    ...
    private List<string> Load()
    {
        ...
        foreach (var s in Resources.LoadAll("Audio/Voice"))
        {
